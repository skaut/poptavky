  ...
  projects: [
    {
      ...
      info: {
        ...
        tags: ["wordpress", "php", "javascript", "google"],
        maintainers: [
          {
    ...
    },
    {
      ...
      info: {
        ...
        "short-description":
          "Plugin pro WordPress, který napojuje přihlašování přes skautIS na skautské weby.",
        description:
        ...
        tags: ["wordpress", "php", "javascript", "skautis"],
        maintainers: [
          {
      ...
      issues: [
        ...
        },
        {
          ...
          description:
            "Musíme pořešit, jak nejlépe integrovat náš plugin s WP 5.x a hlavně Gutenbergem.\r\n\r\nSkrývání bloků, celých stránek... atd",
